...
import { Box, Heading, FormControl, FormLabel, Input, Button, Text, Select } from '@chakra-ui/react';
import api from './axiosInstance'; // assuming you have the axiosInstance2 exported as part of api
    ...
    <Box p={4}>
      ...
      {result && (
        <Box mt={4}>
          ...
          <Text>Class Recommendation: {result.classRecommendation}</Text>
        </Box>
      )}
